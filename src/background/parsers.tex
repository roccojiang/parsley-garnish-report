...
% TODO: crucial difference is that semantic actions (i.e. results of the parser e.g. some datatype like an AST or just evaluation into a result) can be incorporated directly into the parsers themselves
% interact directly with semantic actions within the host language

\subsection{Parsley}
% TODO introduce idea of PEG vs CFGs (see jamies phd? Mascarenhas, Medeiros, and Ierusalimschy [2014])
\TODO{TODO: proper, worked example showcasing relevant design patterns and stuff which will be picked up by the linter}
...
% TODO: just a brief mention of design patterns, they get explored in-text later so I can contextualise them better
...
% \subsection{Parsley Haskell} % probably not worth mentioning staged metaprogramming, it doesn't play a huge role
