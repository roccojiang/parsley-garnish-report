...
This \namecref{sec:normalisation-approach} explores two different notions of normalisation, and the effect this has on how the $\lambda$-calculus may be represented as a datatype.
