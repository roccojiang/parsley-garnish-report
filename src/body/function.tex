...
Unlike traditional normalisation techniques, bypasses rewriting entirely, instead appealing to their denotational semantics.
...
% TODO: replace VarName with Term.Name or String? Or could just leave as is
\begin{minted}{scala}
trait HOAS
case class Abs(n: Int, f: List[HOAS] => HOAS) extends HOAS
case class App(f: HOAS, xs: List[HOAS]) extends HOAS
case class Var(name: VarName) extends HOAS
case class Translucent(t: Term, env: Map[VarName, HOAS]) extends HOAS
\end{minted}
%
