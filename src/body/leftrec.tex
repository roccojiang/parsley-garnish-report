...
\end{itemize}
%
This unfolded parser can then be recombined using the \scala{postfix} combinator.
...
% TODO: note parsley's dynamic analysis divergence detection (see screenshots i left on desktop), could compare with what it can detect? obv the pros of this is i can fix them if i detect them
