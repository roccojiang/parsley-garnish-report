...
\end{itemize}
%
This result is discouraging because it is not impossible to factor out the left-recursion in a nice manner.
A hand-written equivalent using \scala{postfix} would resemble the following parser:
\begin{minted}{scala}
