...
%             height=8cm,
%             xmode=log,
%             xlabel={Average Score (ms/op)},
%             ylabel={Benchmark Levels},
%             ytick={0,1,2,3,4},
%             yticklabels={parser, norm tree, sum tree, eq 20, eq 40},
%             y dir=reverse,
...
%             x dir=both, 
%             x explicit, 
%             error bar style={line width=1pt, solid, color=green},
%             error mark options={rotate=90, line width=1pt, mark size=2pt, color=green}
%         ] 
%         table[y expr=\coordindex-0.25, x=nbe_scores, x error=nbe_errors] {
%             nbe_scores nbe_errors
%             0.013      0
%             0.305      0.002
%             0.297      0.003
%             0.308      0.004
...
%             x dir=both, 
%             x explicit, 
%             error bar style={line width=1pt, solid, color=blue},
%             error mark options={rotate=90, line width=1pt, mark size=2pt, color=blue}
%         ] 
%         table[y expr=\coordindex, x=hoas_scores, x error=hoas_errors] {
%             hoas_scores hoas_errors
%             0.014      0
%             0.332      0.002
%             0.330      0.003
%             0.365      0.001
...
%             x dir=both, 
%             x explicit, 
%             error bar style={line width=1pt, solid, color=red},
%             error mark options={rotate=90, line width=1pt, mark size=2pt, color=red}
%         ] 
%         table[y expr=\coordindex+0.25, x=sub_scores, x error=sub_errors] {
%             sub_scores sub_errors
%             0.537      0
%             36.859     0.451
%             140.8994   0.598
%             541.32     5.690
...
%         % Adding labels with errors
%         \node[anchor=west, green, font=\footnotesize] at (axis cs:0.013+0, -0.25) {0.013 ± 0.00};
%         \node[anchor=west, green, font=\footnotesize] at (axis cs:0.305+0.002, 0.75-0.25) {0.305 ± 0.002};
%         \node[anchor=west, green, font=\footnotesize] at (axis cs:0.297+0.003, 1.75-0.25) {0.297 ± 0.003};
%         \node[anchor=west, green, font=\footnotesize] at (axis cs:0.308+0.004, 2.75-0.25) {0.308 ± 0.004};
%         \node[anchor=west, green, font=\footnotesize] at (axis cs:0.975+0.023, 3.75-0.25) {0.975 ± 0.023};

%         \node[anchor=west, blue, font=\footnotesize] at (axis cs:0.014+0, 0) {0.014 ± 0.00};
%         \node[anchor=west, blue, font=\footnotesize] at (axis cs:0.332+0.002, 1) {0.332 ± 0.002};
%         \node[anchor=west, blue, font=\footnotesize] at (axis cs:0.330+0.003, 2) {0.330 ± 0.003};
%         \node[anchor=west, blue, font=\footnotesize] at (axis cs:0.365+0.001, 3) {0.365 ± 0.001};
%         \node[anchor=west, blue, font=\footnotesize] at (axis cs:1.132+0.013, 4) {1.132 ± 0.013};

%         \node[anchor=west, red, font=\footnotesize] at (axis cs:0.537+0, 0.25) {0.537 ± 0.00};
%         \node[anchor=west, red, font=\footnotesize] at (axis cs:36.859+0.451, 1.25) {36.859 ± 0.451};
%         \node[anchor=west, red, font=\footnotesize] at (axis cs:140.8994+0.598, 2.25) {140.90 ± 0.60};
%         \node[anchor=west, red, font=\footnotesize] at (axis cs:541.32+5.690, 3.25) {541.32 ± 5.69};
%         \node[anchor=west, red, font=\footnotesize] at (axis cs:6226+102.383, 4.25) {6226.00 ± 102.38};

%         \end{axis}
%     \end{tikzpicture}
%     \caption{Benchmark Performance Across Different Levels with Error Bars}
% \end{figure}
\includesvg{assets/test.svg}
